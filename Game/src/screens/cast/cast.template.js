export default `
<section id="cast" >
  <button type="button" class="btn btn-light spell" data-toggle="popover" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Nova</button>
  <hr>
